...
Most of these come down to network reality or how opentdb serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

opentdb rate-limits like any public site. opentdb already paces
...
Where a surface is gated, opentdb reads a cookie or token you supply
...
`opentdb`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what opentdb actually did
